...
int main() {
  ...
  // initialize lane in lane 1.
  int lane = 1;
  // expected speed in mph
  double ref_vel = 0; // cold start
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          // j[1] is the data JSON object
            ...
            // Create a list of widely spread (x,y) waypoints, evely spaced at 30m
            ...
            {
                // N * .02 * vel = d
                double N = (target_dist / (.02*ref_vel/2.24)); // mile/hour -> meter/sec
